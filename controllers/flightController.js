...
/* this function allows validated users to create a booking ticket */
...
const GetAllTicketWithNoAuth = (req, res) => {
    /* this provide response to the user */
    res.status(200).json(ticket)
}

/* for testing purpose to get all users without authentication check*/
const GetAllUsersWithNoAuth = (req, res) => {
    /* this provide response to the user */
    res.status(200).json(users)
}

/* this function deletes all the tickets without validation for testing purpose*/
const DeleteAllTicketsWithNoAuth = (req, res) => {
...
/* this function allow validated users to retieve a particular booking ticket created by the user*/
...
/* this function allow validated users to retieve all the ticket that was created by them*/
...
/* this function allow validated users to update the booking ticket that was created by them*/
const UpdateBookedTicket = (req, res) => {
...
/* this function allow validated users to delete the booking ticket that was created by them*/
const DeletesingleTicket = (req, res) => {
